...
public class OldBuildVariantUpdater {
    @NotNull
    ...
    private static void setupCachedVariant(@NotNull Project project, @NotNull DataNode<ProjectData> variantData, @NotNull Runnable variantSelectionChangeListeners) {
        ...
        Backgroundable task = new Backgroundable(project, "Setting up Project", false) {
            public void run(@NotNull ProgressIndicator indicator) {
                OldBuildVariantUpdater.getLog().info("Starting setup of cached variant");
                ...
                OldBuildVariantUpdater.getLog().info("Finished setup of cached variant");
            }
        };
        if (application.isUnitTestMode()) {
    ...
    private static Logger getLog() {
        return Logger.getInstance(OldBuildVariantUpdater.class);
    }
}
